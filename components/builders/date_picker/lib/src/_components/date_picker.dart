    ...
    return Container(
      child: CalendarDatePicker2(
        config: CalendarDatePicker2Config(
            ...
            firstDate: startBound,
            lastDate: endBound,
            centerAlignModePicker: true,
            dayTextStyle: daysPrimaryStyle,
            nextMonthIcon: leftIcon,
            lastMonthIcon: rightIcon,
            controlsTextStyle: smallTextStyle,
            selectedDayTextStyle: daysPrimaryStyle,
            todayTextStyle: todayTextStyle,
            monthTextStyle: smallTextStyle,
            yearTextStyle: smallTextStyle,
            hideNextMonthIcon: false
        ),
        value: [selectedDate],
        onValueChanged: (dates) => _onDayPressed(dates.first),
      ),
    );
  }
